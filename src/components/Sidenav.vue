  ...
  <div>
    ...
    <b-card title="映画作品" class="mt-4">
      <b-form @submit.prevent="addMovie">
        <b-form-group label="作品名" label-for="input-movie-name">
          <b-form-input
        ...
        <b-form-group label="ジャンル" label-for="input-movie-genre">
          <b-form-input
        ...
        <b-form-group label="監督" label-for="input-movie-director">
          <b-form-select
